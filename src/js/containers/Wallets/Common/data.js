...
export const sendFromAccount = (
    ethereum, account, sourceToken, sourceAmount,
    destAddress, nonce, gas, gasPrice) => {
      console.log({ethereum, account, sourceToken, sourceAmount,
        destAddress, nonce, gas, gasPrice})
